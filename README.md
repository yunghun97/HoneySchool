# 🍀 HoneySchool
![image](https://user-images.githubusercontent.com/71022555/162619956-c899f044-b17b-4f02-b7e8-70f842c76227.png)  

## 초등학생을 위한 화상회의 사이트
  
# 🎨 기획 배경
### - 코로나 19로 인한 학습 격차 실태를 줄이기 위해
### - 기존의 ZOOM 사용이 초등학생에겐 어렵기 때문에
### - 기존 ZOOM과 다르게 학생 관리를 편하게 할 수 있도록  
...
## Backend
- 권영현 : 배포, Openvidu(WebRTC)
- 박윤지 : 학급 게시판
- 정희연 : 회원 관리
  
# ⚙ 기술 스택 및 아키텍쳐
![image](https://user-images.githubusercontent.com/71022555/162620296-03f3ef61-715c-4a02-aa11-da78187177ad.png)  
